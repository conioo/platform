...
export async function TranslateSentences(sentences: Array<string>, language: Language, targetLanguage: TargetLanguage, deeplToken: string | undefined): Promise<Array<string>> {
